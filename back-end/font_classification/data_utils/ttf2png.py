...
if __name__ == '__main__':
    ...
    parser.add_argument('--ttf_path', type=str,
                        default='/root/autodl-tmp/code/mxfont/data/ttfs/val/MaShanZheng-Regular.ttf')
    parser.add_argument('--ttf_folder', type=str,
                        default=None)
    parser.add_argument('--img_save_folder', type=str, default='/root/autodl-tmp/font_classification/dataset_img')
    parser.add_argument('--text', type=str, default='岸低度根湖灰加交街可令留落似特推武由自尊')
